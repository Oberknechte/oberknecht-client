...
class privmsgMessage {
    ...
    async ban(reason) {
        return __1.i.OberknechtAPI[this.sym].ban(this.channelID, this.senderUserID, reason);
    }
    async unban() {
        return __1.i.OberknechtAPI[this.sym].unban(this.channelID, this.senderUserID);
    }
    async timeout(duration, reason) {
        return __1.i.OberknechtAPI[this.sym].timeout(this.channelID, this.senderUserID, duration, reason);
    }
    async untimeout() {
        return __1.i.OberknechtAPI[this.sym].unban(this.channelID, this.senderUserID);
    }
    async delete() {
        return __1.i.OberknechtAPI[this.sym].deleteMessage(this.channelID, this.messageID);
    }
    async shoutout() {
        return __1.i.OberknechtAPI[this.sym].shoutout(this.channelID, this.senderUserID);
    }
    async announce(message, color) {
        return __1.i.OberknechtAPI[this.sym].announce(this.channelID, message, color);
    }
    async slow(wait_time) {
        return __1.i.OberknechtAPI[this.sym].slow(this.channelID, wait_time);
    }
    async slowOff() {
        return __1.i.OberknechtAPI[this.sym].slowOff(this.channelID);
    }
    async followers(duration) {
        return __1.i.OberknechtAPI[this.sym].followers(this.channelID, duration);
    }
    async followersOff() {
        return __1.i.OberknechtAPI[this.sym].followersOff(this.channelID);
    }
    async subscribers() {
        return __1.i.OberknechtAPI[this.sym].subscribers(this.channelID);
    }
    async subscribersOff() {
        return __1.i.OberknechtAPI[this.sym].subscribersOff(this.channelID);
    }
    async emoteOnly() {
        return __1.i.OberknechtAPI[this.sym].emote(this.channelID);
    }
    async emoteOnlyOff() {
        return __1.i.OberknechtAPI[this.sym].emoteOff(this.channelID);
    }
    async r9k() {
        return __1.i.OberknechtAPI[this.sym].r9k(this.channelID);
    }
    async r9kOff() {
        return __1.i.OberknechtAPI[this.sym].r9kOff(this.channelID);
    }
    async chatdelay(duration) {
        return __1.i.OberknechtAPI[this.sym].chatdelay(this.channelID, duration);
    }
    async chatdelayOff() {
        return __1.i.OberknechtAPI[this.sym].chatdelayOff(this.channelID);
    }
    async mod(userid) {
        return __1.i.OberknechtAPI[this.sym].mod(userid);
    }
    async unmod(userid) {
        return __1.i.OberknechtAPI[this.sym].unmod(userid);
    }
    async vip(userid) {
        return __1.i.OberknechtAPI[this.sym].vip(userid);
    }
    async unvip(userid) {
        return __1.i.OberknechtAPI[this.sym].unvip(userid);
    }
    async raid(to_broadcaster_id) {
        return __1.i.OberknechtAPI[this.sym].raid(this.channelID, to_broadcaster_id);
    }
    async unraid(broadcaster_id) {
        return __1.i.OberknechtAPI[this.sym].unraid(broadcaster_id);
    }
    async updateColor(color) {
        return __1.i.OberknechtAPI[this.sym].updateColor(color);
    }
    async getColor(userids) {
        return __1.i.OberknechtAPI[this.sym].getColor(userids);
    }
    async send(message) {
        return (0, privmsg_1.privmsg)(this.sym, this.channelName, message).catch();
    }
    async reply(message) {
        return (0, reply_1.reply)(this.sym, message, this.channelName, this.messageID).catch();
    }
    async action(message) {
        return (0, action_1.action)(this.sym, this.channelName, message).catch();
    }
    async sendRaw(message) {
        return (0, sendraw_1.sendraw)(this.sym, message).catch();
    }
    async whisper(message) {
        return (0, whisper_1.whisper)(this.sym, this.senderUserID, message).catch();
    }
}
