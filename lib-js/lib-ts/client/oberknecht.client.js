...
class oberknechtClient {
    ...
    ;
    get clientData() { return __1.i.clientData[this.symbol]; }
    ;
    get _allIndex() { return __1.i; }
    ;
    ...
    ;
    get channels() { return __1.i.clientData[this.symbol].channels ?? []; }
    ;
    get wsUptime() { return ((__1.i.reconnectingKnechtClient[this.symbol]?.[0]?.startTime ?? undefined) ? (Date.now() - __1.i.reconnectingKnechtClient[this.symbol]?.[0]?.startTime) : null); }
    ;
    get wsNum() { return __1.i.clientData[this.symbol].wsNum; }
    ;
    get wsConnections() { return __1.i.clientData[this.symbol].wsConnections; }
    ;
    ...
    ;
    privmsg = (channel, message) => { return (0, privmsg_1.privmsg)(this.symbol, channel, message); };
    send = this.privmsg;
    say = this.privmsg;
    action = (channel, message) => { return (0, action_1.action)(this.symbol, channel, message); };
    sendRaw = (message) => { return (0, sendraw_1.sendraw)(this.symbol, message); };
    join = (channel) => { return (0, join_1.join)(this.symbol, channel); };
    joinAll = (channels) => { return (0, joinAll_1.joinAll)(this.symbol, channels); };
    part = (channel) => { return (0, part_1.part)(this.symbol, channel); };
    partAll = (channels) => { return (0, partAll_1.partAll)(this.symbol, channels); };
    ping = () => { return (0, ping_1.ping)(this.symbol); };
    whisper = (targetUser, message, customtoken) => { return (0, whisper_1.whisper)(this.symbol, targetUser, message, customtoken); };
    ...
    getuser = async (login, id, noautofilterids) => { return (0, getusers_1.getusers)(this.symbol, login, id, true, noautofilterids); };
    getusers = async (logins, ids, noautofilterids) => { return (0, getusers_1.getusers)(this.symbol, logins, ids, null, noautofilterids); };
    ...
    onAutojoin = (callback) => { this.on("autojoin", callback); };
}
