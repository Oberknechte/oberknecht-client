...
async function unvip(sym, broadcaster_id, user_id, customtoken) {
    return new Promise(async (resolve, reject) => {
        ...
        request(`${urls._url("twitch", "unvip")}?broadcaster_id=${broadcaster_id}&user_id=${user_id}`, { method: urls.twitch.unvip.method, headers: urls.twitch._headers(sym, customtoken, clientid) }, (e, r) => {
            if (e || (r.statusCode !== urls._code("twitch", "unvip"))) return reject(Error(e ?? r.body));
