...
async function vip(sym, broadcaster_id, user_id, customtoken) {
    return new Promise(async (resolve, reject) => {
        ...
        request(`${urls._url("twitch", "vip")}?broadcaster_id=${broadcaster_id}&user_id=${user_id}`, { method: urls.twitch.vip.method, headers: urls.twitch._headers(sym, customtoken, clientid) }, (e, r) => {
            if (e || (r.statusCode !== urls._code("twitch", "vip"))) return reject(Error(e ?? r.body));
