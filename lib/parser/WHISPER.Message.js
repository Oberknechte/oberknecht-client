const { messageBadges, messageCommand, messageContent, messageEmotes, messageParameters, messagePrefix, messageUser } = require("oberknecht-utils");
...
class whisperMessage {
    ...
    constructor(sym, rawMessage) {
        ...
        this.send = this.whisper;
        this.reply = this.whisper;
        this.action = this.whisper;
