...
const _getclientid = require("../operations/api/twitch/_getclientid");
...
function messageParser(sym, rawMessage) {
    ...
    // if (ircCommand === "NOTICE") return handleNotice(sym, rawMessage);
    ...
    switch (ircCommand) {
        ...
        case "PRIVMSG": {
            ...
            i.OberknechtEmitter[sym].emit([`irc:${ircCommand.toLowerCase()}`, ircCommand], privmsg, privmsg.channelName, privmsg.senderUserName, privmsg.messageText);
            break;
        };
