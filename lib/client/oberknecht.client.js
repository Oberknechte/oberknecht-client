...
class oberknechtClient {
    ...
    constructor(options) {
        ...
        this._options.max_channels_per_ws = (this._options.max_channels_per_ws ?? 100);
        ...
        this.API = new oberknechtAPI({
            ...
            startPath: this._options.apiStartPath,
            saveIDs: this._options.saveIDs
        });
    ...
    getusername = (userid) => { return this.API._getUsers([], userid) };
    getuserid = (username) => { return this.API._getUsers(username) };
