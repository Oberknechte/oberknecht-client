...
class oberknechtClient {
    ...
    static clientData = this.clientData;
    static _allIndex = this._allIndex;
    static symbol = this.symbol;
    static uptime = this.uptime;
    static channels = this.channels;
    static wsUptime = this.wsUptime;
    static wsNum = this.wsNum;
    static wsConnections = this.wsConnections;
    static isConnected = this.isConnected;
