...
class oberknechtClient {
    ...
    constructor(options) {
        ...
        this.API = new oberknechtAPI({
            ...
            use3rdparty: (options.apiuse3rdparty ?? {})
        });
    ...
    getuser = async (usernameorid) => { return getusers(this.symbol, usernameorid, true) };
    /** @returns {Array<{}>} */
    getusers = async (usernamesorids) => { return getusers(this.symbol, usernamesorids) };
