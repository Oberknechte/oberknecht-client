...
class oberknechtClient {
    ...
    static get options() { return i.clientData[this.symbol]?._options ?? {} };
    static get clientData() { return i.clientData[this.symbol] };
    static get _allIndex() { return i };
    ...
    static get uptime() { return (Date.now() - this.#startTime) };
    static get channels() { return i.clientData[this.symbol].channels ?? []; };
    static get wsUptime() { return ((i.reconnectingKnechtClient[this.symbol]?.[0]?.startTime ?? undefined) ? (Date.now() - i.reconnectingKnechtClient[this.symbol]?.[0]?.startTime) : null) };
    static get wsNum() { return i.clientData[this.symbol].wsNum };
    static get wsConnections() { return i.clientData[this.symbol].wsConnections };
    static get isConnected() { return this.wsConnections.length > 0 };
