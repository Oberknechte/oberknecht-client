...
function handleNotice(sym, rawMessage){
    let notice = new noticeMsg(rawMessage);
    switch (notice.msgID){
        case "cmds_available":
        ...
        {
            i.OberknechtEmitter.emit(["irc:notice","irc:notice:reject"], rawMessage);
            i.OberknechtactionEmitter.emitreject("PRIVMSG", rawMessage);
            break;
        }
        ...
        {
            i.OberknechtEmitter.emit(["irc:notice","irc:notice:resolve"], rawMessage);
            i.OberknechtactionEmitter.emitresolve("PRIVMSG", rawMessage);
            break;
        }
        ...
        {
            i.OberknechtEmitter.emit(["irc:notice","irc:notice:rejectsuccess","irc:notice:success"], rawMessage);
            break;
        }
        ...
        {
            i.OberknechtEmitter.emit(["irc:notice","irc:notice:usage"], rawMessage);
            break;
        }
