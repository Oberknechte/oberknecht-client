...
function handleNotice(sym, rawMessage) {
    ...
    switch (notice.msgID) {
        ...
        case "whisper_restricted_recipient":
            ...
            {
                i.OberknechtEmitter[sym].emit(["irc:notice", "irc:notice:reject"], rawMessage);
        ...
        case "delete_staff_message_success":
            ...
            {
                i.OberknechtEmitter[sym].emit(["irc:notice", "irc:notice:resolve"], rawMessage);
        ...
        case "bad_mod_mod":
            ...
            {
                i.OberknechtEmitter[sym].emit(["irc:notice", "irc:notice:rejectsuccess", "irc:notice:success"], rawMessage);
                break;
            }
        ...
        case "usage_whisper":
            ...
            {
                i.OberknechtEmitter[sym].emit(["irc:notice", "irc:notice:usage"], rawMessage);
                break;
            }
        ...
        case "subs_on":
            ...
            {
                i.OberknechtEmitter[sym].emit(["irc:notice", "irc:notice:info"], rawMessage);
                break;
            }
