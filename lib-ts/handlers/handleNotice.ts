...
export function handleNotice(sym: string, rawMessage: string, wsnum: number) {
  ...
  switch (notice.msgID) {
    ...
    {
      i.OberknechtEmitter[sym].emit(
        ["irc:notice:resolve", `irc:${wsnum}:notice:resolve`],
        rawMessage
      );
    ...
    {
      i.OberknechtEmitter[sym].emit(
        ["irc:notice:usage", `irc:${wsnum}:notice:usage`],
        rawMessage
      );
      break;
    }
    ...
    {
      i.OberknechtEmitter[sym].emit(
        ["irc:notice:info", `irc:${wsnum}:notice:info`],
        rawMessage
      );
      break;
    }
    ...
    {
      i.OberknechtActionEmitter[sym].emitreject(
        "353",
