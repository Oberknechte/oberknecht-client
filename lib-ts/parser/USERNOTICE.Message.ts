import { BadgesMap, cleanChannelName, messageBadges, messageCommand, messageContent, messageEmotes, messageEmotesReturn, messageParameters } from "oberknecht-utils";
import { i } from "..";
...
export class usernoticeMessage {
    ...
    async announce(message: string) { return i.OberknechtAPI[this.sym].announce(message) };
