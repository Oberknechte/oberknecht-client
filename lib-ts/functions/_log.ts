...
export function _log(sym: symbol, logopt: 0 | 1 | 2, debugnum: number, logmsg: string | Error, logcolorfg?: string, logcolorbg?: string) {
    ...
    if (i.clientData[sym]?._options?.debug >= debugnum) switch (logopt) { default: case 0: return console.log(...logm); case 1: return console.info(...logm); case 2: return console.error(...logm); };
};